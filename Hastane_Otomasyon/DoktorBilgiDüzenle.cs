...
namespace Hastane_Otomasyon
{
    public partial class DoktorBilgiDüzenle : Form
    {
        ...
        private void DoktorBilgiDüzenle_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("select * from Tablo_Doktor where DoktorTc=@p1", bgl.baglanti());
        ...
        {
            SqlCommand komut1 = new SqlCommand("update Tablo_Doktor set DoktorAd=@p1,DoktorSoyad=@p2,DoktorBrans=@p3,DoktorSifre=@p4 where DoktorTc=@p5", bgl.baglanti());
